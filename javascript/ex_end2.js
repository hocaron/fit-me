...
var i=0
var exercise = ['','60초 동안 손을 모으고 숨을 깊게 쉬세요','']
...
function timeDown() {
  ...
  if (timerValue==0 || (start==true && timerValue<0)) {
    ...
    else{setTimeout(function(){timerValue=5},2000)}
    start=false;
    i+=1;
    clear()
    method=exercise[i];
    document.getElementById("method").innerHTML=method;
    document.getElementById("image").innerHTML="<img src='./data/cardio/breath.gif'>";
    ding.play();
  }

  if (i==2){
    clear();
    location.href='introduction0.html'
  }
}
