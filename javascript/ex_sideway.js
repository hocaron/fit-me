...
var i=0
var exercise = ['','양팔을 펴고,오른쪽 방향으로 당겨주세요.','반대 방향으로 당겨주세요.','']
...
function timeDown() {
    ...
    document.getElementById("image").innerHTML="<img src='./data/arm/side"+i+".png'>";
    ding.play();
    timerValue=5;

  }
  if(i==3){
    location.href='ex_waist.html'};
  }
