...
var i=0
var exercise = ['','60초 동안 제자리에서 천천히 걸으세요','']
...
function timeDown() {
  ...
  document.getElementById("image").innerHTML="<img src='./data/cardio/walk1.gif'>";
  ding.play();
}
